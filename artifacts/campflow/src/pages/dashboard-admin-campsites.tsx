...
import { apiError, createCampsite, deleteCampsite, idOf, labelOf, listCampgrounds, listCampsites, updateCampsite, type ApiItem } from '@/services/operationsDashboardService';
